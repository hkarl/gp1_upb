...
Spannender Punkt: Was ist mit Variable, die nicht global, aber in der
...
- Also wird der Aufruf ~g()~ auch die gleiche Funktion aufrufen
  - Der Name der referenzierenden Variable ist /irrelevant/! 
...
- Offenbar behält die Funktion, die unter ~h~ im globalen Scope
  bekannt ist, Zugriff auf die Variable ~n~
...
- Funktionsnamen sind eigentlich auch nur Variablen, die  ein
