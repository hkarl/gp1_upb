...
- Ordnet /*Schlüsseln*/ (keys)  Objekten  (Werten, values) zu
...
- In geschweiften Klammern, die Schlüssel/Wert-Paaren aufzählen, mit
  Komma getrennt 
...
so ist das Objekt als Parameter des gewünschten Typs angegeben. Die
