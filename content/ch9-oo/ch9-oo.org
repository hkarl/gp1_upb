...
** Neue Methoden im Artikel-Beispiel 
...
*** Kompatibilität zwischen Ober- und Unterklasse		     :B_note:
    :PROPERTIES:
    :BEAMER_env: note
    :END:

Jedes Objekt einer Oberklasse kann durch ein Objekt einer Unterklasse
ersetzt werden. Objekte einer Unterklasse können den Platz von
Objekten der Oberklasse einnehmen. Sie können dabei durch
überschriebene Methoden adaptiertes Verhalten zeigen. 
...
- Option 1:
  - Nur manche Methoden, Attribute einer Klasse /öffentlich/
    zugänglich machen
