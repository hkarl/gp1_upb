...
- Wir nehmen hier Anlauf, um nicht in der unübersichtlichen Syntax von
  Java den Blick für das Wesentliche zu verlieren 
...
#+ATTR_LaTeX: :width 0.25\linewidth
#+NAME: fig:klein-an-groß
[[./uml/boxshapes-6.png]]


#+CAPTION: Groen Wert an kleine Variable zuweisen scheitert
#+ATTR_LaTeX: :width 0.25\linewidth
#+NAME: fig:klein-an-groß
[[./uml/boxshapes-7.png]]
