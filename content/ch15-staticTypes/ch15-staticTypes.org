...
- Wären diese Fehler nicht vermeidbar gewesen?
  - Mit einer besseren Prog-Vorlesung: Vielleicht!
...
#+CAPTION: Wert kleinen Typs an  Variable großen Typs zuweisen gelingt 
#+ATTR_LaTeX: :width 0.25\linewidth
#+NAME: fig:klein-an-gross
[[./uml/boxshapes-6.png]]


#+CAPTION: Wert großen Typs an  Variable kleinen Typs zuweisen scheitert
#+ATTR_LaTeX: :width 0.25\linewidth
...
- Einer dynamisch typisierten Sprache etwas mehr statische
  ...
  - Python Type Hints erreichen viele der hier erhofften Vorteile
