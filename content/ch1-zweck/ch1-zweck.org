...
#+CAPTION: Das Modul I.1.1 im Studienverlauf
#+NAME: modul-I11
[[./figures/studienverlauf.png]]
...
- Ziel des Moduls „Programmiertechnik“:
  - Das Modul vermittelt einführende und grundlegende Kenntnisse und Fähigkeiten in der Programmierung
...
- Handlungsvorschrift zur Lösung eines bestimmten Problems
...
** Programmiersprache - Definition				   :subslide:
...
- Stark unterschiedliche Ansätze zwischen Sprachen
  - C: ???
  - Python: [[https://pypi.python.org/pypi/pip][Python Package Index]]
    (~pip~), [[http://conda.pydata.org/docs/][Conda]], ... 
- Beispiele: Später 
