...
- Bisher nur Ausdrücke, die keine Zustandsänderung bewirkten 
...
- Wie können wir wieder benutzen? 
...
*** Schilder an Werten oder Boxen mit Aufschrift?		       :note:
...
Ein /Schlüsselwort/ (reserviertes Wort, reservierte Name, key word) ist ein Bezeichner,
...
Übernehmen
Sie diese Zeile *nicht*, wenn Sie das Programm ausserhalb eines
Notebooks (z.B. in einem Terminal-Fenster)  ausführen wollen. 
...
- In Ausdrücken, Variablennamen können wir Werte benutzt werden 
...
1. *Alle* Ausdrücke auf der linken Seite werden ausgewertet
...
Bei einer Zuweisung werden ein oder mehrere *Name* mit einem oder
mehreren Wert verbunden.  Der Name *referenziert* den entsprechenden
...
ist. Diese Typen-Information ist im Programm-Code nicht explizit
...
Typen-Informationen explizit im Programm-Code angegeben werden
müssen. Aus der Betrachtung des Programm-Codes kann der Typ eines
Wertes abgeleitet werden, bereits bevor das Programms selbst abläuft. 
...
- Daher: *Stilregeln* (*/sytle guides/*) für /*Konsistenz*/
...
- Beispiele:
  ...
  - Leerzeichen
    ...
    - Nicht nach öffender oder vor schließender Klammer
...
Auch: Empfehlen zu Struktur, etwas bei Kommentaren 
...
*** UEBUNG Leerzeichen in arithmetischen Asudrücken 
...
- Die Repräsentation des Typs (in Wert oder Variable) unterscheidet
  dynamisch von statisch typisieren Programmiersprachen 
