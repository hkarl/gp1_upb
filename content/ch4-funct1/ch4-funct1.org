...
- Namen für Funktionen folgen den Syntaxregeln der Namen für Variablen
  (gleiche Bezeichner). 
...
- Syntaxregel für Funktionsnamen: Wie für Variablennamen 
...
** Starke Analogie: Variablenname, Funktionsname 
