...
- Betonung einiger Aspekte der aktuellen Java Version 8, 9 
...
- Angenommen, wir wollen dieses ~m~ in einer anderen Methode ~m1~
  nutzen 
- Dann müssen alle von ~m~ (möglicherweise) geworfenen Exceptions entweder
...
- Andernfalls: Compiler stellt fest, dass nicht alle Exceptions
  behandelt werden
...
#+BEGIN_SRC java :exports both :results output :classname Lambda
...
- Anweisung: ~import~
  ...
  - Folge der Paketnamen und Klassenname!
...
Nach [[https://blog.idrsolutions.com/2017/05/java-9-modularity-explained-in-5-minutes/][Blog]]: 

- Ein Modul: Eine Sammlung von Klassen, Daten, und explizite
  Abhängigkeiten von anderen Modulen
- "Similar to JAR files but better"
  - Soll Code-Austausch und Zusammenarbeit verbessern
  - "No one would be able to access code which we don’t want others to
    see. " 
- Braucht ein eigenes Buch zur Erklärung 
...
: Hallo
: GP1
: it ==> java.util.ArrayList$Itr@56ef9176
: Hallo
: GP1
