...
- Aber auch die sind statisch typisiert!
  - Man muss also die Signatur angeben (plus Rückgabewert)
  - Dazu: Interface mit einer Methode deklarieren
    - Darf anonym passieren; Interface braucht keinen Namen 
- Lambda-Ausdruck dann bei Zuweisung an Funktionsvariable 

** Java 8: Lambda-Ausdrücke -- Beispiel 
