...
#+BEGIN_LaTeX
Abbildung~\ref{fig:repl}  zeigt die Read-Evaluate-Print-Schleife eines Interpreters. Beachten Sie die Analogie zu einem Maschinenmodell: Ein Interpreter ist in gewissem Sinne eine (sehr abstrakte) Form eine Maschine.  
#+END_LaTeX
