...
- Wir hatten versucht, Probleme durch Rückgabewerte dem Aufrufer
  mitzuteilen
- Das funktioniert bestenfalls kläglich 

** Dieses Kapitel 

- Ein konsistentes Vorgehen, um mit Fehlern und Ausnahmen umzugehen
  - Fehler zu signalisieren (z.B. zwischen Funktion und Aufrufer)
  - Fehler zu behandeln, weiter zu reichen oder zu ignorieren
- Objektorientiert: Fehler sind ebenfalls Objekte 
...
- Man erkennt nicht mehr die Struktur des Programs, des Algorithmus
...
Zur Behandlung von Ausnahmen /verändern wir das Ausführungsmodell/: Es wird
nicht die nächste Anweisung ausgeführt, sondern die Folge der
Anweisungen abgebrochen und der zugehörige Ausnahmebehandler 
(/exception handler/) zur Ausführung gebracht. 
...
behandelt werden müsste (mehr dazu siehe unten, Abschnitt
...
Funktion /abgebrochen/ und zum umgebenen ~try~-Block zurückgekehrt. 
...
** ~finally~ auch ohne ~except~ ausgeführt		  :dropslide:nolatex:
...
Aber was immer Sie tun, schreiben Sie sinnvolle Fehlermeldungen
https://xkcd.com/2200/ 

#+CAPTION: Sinnvolle Fehlermeldungen 
#+ATTR_LaTeX: :width 0.25\linewidth
#+NAME: fig:tired_error
[[./figures/unreachable_state.png]]
